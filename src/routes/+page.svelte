  ...
  <section class="mb-12">
    <p class="text-lg text-gray-700 dark:text-gray-300">
      ...
      <a
        ...
        rel="external"
        class="hover:text-gray-600 dark:hover:text-gray-400">Gusto</a
      >. Founding member of
      <a href="https://gem.coop" rel="external" class="hover:text-gray-600 dark:hover:text-gray-400"
        >gem.coop</a
      >. See also:
      <a
        href="https://github.com/martinemde"
        rel="external"
        class="hover:text-gray-600 dark:hover:text-gray-400">GitHub</a
      >.
    </p>
  </section>
  ...
  <section>
    ...
    <div class="space-y-12">
      {#each data.recentPosts as post (post.slug)}
        <article class="border-b border-gray-200 pb-12 dark:border-gray-800">
          <h3 class="mb-2 text-2xl font-semibold">
            <a href="/blog/{post.slug}" class="hover:text-gray-600 dark:hover:text-gray-400">
              {post.title}
            </a>
          </h3>
