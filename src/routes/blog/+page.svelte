	...
	const posts = [
		{
			...
			url: '/2024/12/21/how-to-convert-to-rails-params-expect.html'
		},
		{
			...
			url: '/2024/10/22/how-to-rails-params-expect.html'
		}
	];
</script>
...
<svelte:head>
	...
	<meta
		name="description"
		content="Technical blog posts about Ruby, Rails, and software engineering"
	/>
</svelte:head>
...
<div class="mx-auto max-w-4xl">
	...
	<div class="space-y-8">
		{#each posts as post (post.url)}
			<article class="card variant-filled-surface p-8">
				<div class="prose prose-lg max-w-none">
					<h2 class="h2 mb-4">
						<a href={post.url} class="anchor">
							{post.title}
						</a>
					</h2>
					<div class="text-surface-500 mb-4 text-sm">
					...
					<p>
						<a href={post.url} class="btn variant-filled-primary"> Read more </a>
					</p>
				</div>
			</article>
		{/each}
